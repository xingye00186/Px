...
class PhpDumpStrategy implements DumpStrategy
{
    ...
    public function dump(string $caseName, string $refDir): ?array
    {
        ...
        $coreFiles = [
            ...
            $fwDir . '/Platform/RenderSurface.php',
            $fwDir . '/Platform/ViewMetrics.php',
            $fwDir . '/Platform/PointerEvent.php',
            $fwDir . '/Platform/KeyEvent.php',
            $fwDir . '/Platform/LifecycleEvent.php',
            $fwDir . '/Platform/MetricsEvent.php',
            $fwDir . '/Platform/RedrawEvent.php',
