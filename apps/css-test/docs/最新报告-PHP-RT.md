...
**运行时间**: 2026-07-27 16:20:06 | **总耗时**: 52s
...
| case-049-multi-column | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 272diff 🔴230 | ⏭️ | ❌ 失败 | 0.2s |
...
**汇总**: 4 ✅ / 51 ❌ / 55 总计 (总耗时: 52s)

## 回归判定

> 🔴 **检测到回归** — 与上一次运行相比，以下指标恶化:
>
> - case-049-multi-column major 3->36
>
...
| case-049-multi-column | 3 | **230** | **36** | 6 | 0 | 0 |
