...
**运行时间**: 2026-07-05 08:40:59 | **总耗时**: 689.2s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| case-001-wrapper-x | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ⚠️ 3 | 447diff 🔴322 | ⏭️ | ❌ 失败 | 1.5s |
...
**汇总**: 0 ✅ / 55 ❌ / 55 总计 (总耗时: 689.2s)

## 回归判定

> 🔴 **检测到回归** — 与上一次运行相比，以下指标恶化:
>
> - prop width diff 275->287
> - case-001-wrapper-x major 0->120
...
|------|:-------------:|:-----------:|:------------:|:-------------:|:---------------:|:------------:|
| case-001-wrapper-x | 0 | **322** | **120** | 4 | 0 | 3 |
