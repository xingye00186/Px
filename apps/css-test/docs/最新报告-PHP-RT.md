...
**运行时间**: 2026-07-28 08:48:50 | **总耗时**: 40.4s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| case-001-wrapper-x | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 33.4s |
...
| case-037-direction-rtl | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 32diff 🟡32 | ⏭️ | ❌ 失败 | 0.1s |
...
| case-037-direction-rtl | 0 | 0 | **32** | 0 | 0 | 0 |
