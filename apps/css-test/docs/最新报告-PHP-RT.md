...
**汇总**: 0 ✅ / 55 ❌ / 55 总计 (总耗时: 687.7s)

## 回归判定

> 🔴 **检测到回归** — 与上一次运行相比，以下指标恶化:
>
> - prop width diff 275->281
> - case-001-wrapper-x major 0->3
> - case-002-auto-height geometry 296->332
...
| case-002-auto-height | 0 | **232** | **98** | 7 | 0 | 0 |
