...
**运行时间**: 2026-07-27 10:31:12 | **总耗时**: 53.3s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| case-001-wrapper-x | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 42s |
...
| case-032-scroll-relative | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 1diff 🔴1 | ⏭️ | ❌ 失败 | 0.6s |
...
| case-046-appearance | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 232diff 🔴185 | ⏭️ | ❌ 失败 | 0.2s |
| case-047-object-fit | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 46diff 🟡30 | ⏭️ | ❌ 失败 | 0.2s |
| case-048-table-props | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 334diff 🔴253 | ⏭️ | ❌ 失败 | 0.2s |
| case-049-multi-column | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 321diff 🔴308 | ⏭️ | ❌ 失败 | 0.3s |
...
**汇总**: 4 ✅ / 51 ❌ / 55 总计 (总耗时: 53.3s)

## 回归判定

> 🔴 **检测到回归** — 与上一次运行相比，以下指标恶化:
>
> - case-050-text-emphasis geometry 260->261
> - case-050-text-emphasis major 145->161
>
...
| 属性 | 通过率 | 通过/总 |
|------|--------|--------|
| width | 98.3% | 8346/8491 |
| height | 98.7% | 8383/8491 |
...
| case-046-appearance | 2 | **185** | **12** | 22 | 5 | 0 |
