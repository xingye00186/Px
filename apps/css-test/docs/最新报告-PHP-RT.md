...
**运行时间**: 2026-07-05 00:50:28 | **总耗时**: 689.3s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| case-001-wrapper-x | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ⚠️ 3 | 453diff 🔴324 | ⏭️ | ❌ 失败 | 1.7s |
...
> - case-001-wrapper-x mismatch 5->7
...
|------|:-------------:|:-----------:|:------------:|:-------------:|:---------------:|:------------:|
| case-001-wrapper-x | 0 | **324** | **120** | 7 | 0 | 3 |
