...
**运行时间**: 2026-07-28 08:30:54 | **总耗时**: 41.4s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| case-001-wrapper-x | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 34.3s |
...
| case-021-line-height | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 54diff 🟡38 | ⏭️ | ❌ 失败 | 0.1s |
| case-022-white-space | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 2diff | ⏭️ | ❌ 失败 | 0.1s |
| case-023-word-break | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 29diff 🟡29 | ⏭️ | ❌ 失败 | 0.1s |
| case-024-font-weight | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 30diff 🟡30 | ⏭️ | ❌ 失败 | 0.1s |
...
| case-035-text-indent | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 68diff 🟡54 | ⏭️ | ❌ 失败 | 0.1s |
| case-036-background-repeat | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 31diff 🟡31 | ⏭️ | ❌ 失败 | 0.1s |
| case-037-direction-rtl | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 88diff 🔴56 | ⏭️ | ❌ 失败 | 0.1s |
...
| case-046-appearance | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 132diff 🔴73 | ⏭️ | ❌ 失败 | 0.1s |
...
| case-050-text-emphasis | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 278diff 🔴50 | ⏭️ | ❌ 失败 | 0.2s |
...
> - case-046-appearance major 13->34
...
| case-023-word-break | 0 | 0 | **29** | 0 | 0 | 0 |
| case-024-font-weight | 0 | 0 | **30** | 0 | 0 | 0 |
| case-025-english-text | 0 | 0 | 0 | 0 | 0 | 0 |
| case-026-font-style | 0 | 0 | **29** | 10 | 0 | 0 |
...
| case-040-word-wrap | 0 | 0 | **48** | 0 | 0 | 0 |
...
| case-046-appearance | 2 | **73** | **34** | 22 | 0 | 0 |
| case-047-object-fit | 0 | 0 | **30** | 16 | 0 | 0 |
| case-048-table-props | 0 | **19** | **31** | 47 | 0 | 0 |
