...
**运行时间**: 2026-07-09 21:25:05 | **总耗时**: 64.2s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| case-001-wrapper-x | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 186diff 🔴181 | ⏭️ | ❌ 失败 | 61.7s |
...
**汇总**: 0 ✅ / 55 ❌ / 55 总计 (总耗时: 64.2s)

## 回归判定

> 🔴 **检测到回归** — 与上一次运行相比，以下指标恶化:
>
> - case-001-wrapper-x geometry 0->185
> - case-001-wrapper-x mismatch 0->1
> - case-001-wrapper-x critical 0->181
...
|------|:-------------:|:-----------:|:------------:|:-------------:|:---------------:|:------------:|
| case-001-wrapper-x | 0 | **181** | **3** | 1 | 0 | 0 |
