...
**运行时间**: 2026-07-28 19:57:29 | **总耗时**: 53.5s
...
| case-054-inline-block-nest | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 15diff 🔴9 | ⏭️ | ❌ 失败 | 0.1s |
| case-055-sticky-multi | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 12diff 🔴4 | ⏭️ | ❌ 失败 | 0.1s |

**汇总**: 30 ✅ / 25 ❌ / 55 总计 (总耗时: 53.5s)

## 回归判定

> 🔴 **检测到回归** — 与上一次运行相比，以下指标恶化:
>
> - case-054-inline-block-nest critical 8->9
>
...
| case-054-inline-block-nest | 0 | **9** | **4** | 2 | 0 | 0 |
