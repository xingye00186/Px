...
**运行时间**: 2026-07-27 08:35:36 | **总耗时**: 53s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| case-001-wrapper-x | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 41.7s |
...
| case-012-position-relative | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 41diff 🔴1 | ⏭️ | ❌ 失败 | 0.1s |
| case-013-z-index | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 84diff 🔴84 | ⏭️ | ❌ 失败 | 0.1s |
| case-014-overflow-hidden | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 27diff 🔴22 | ⏭️ | ❌ 失败 | 0.1s |
| case-015-min-max-height | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 118diff 🔴51 | ⏭️ | ❌ 失败 | 0.2s |
...
| case-019-visibility | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 234diff 🔴144 | ⏭️ | ❌ 失败 | 0.2s |
| case-020-text-align | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 126diff 🔴3 | ⏭️ | ❌ 失败 | 0.1s |
| case-021-line-height | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 133diff 🟡106 | ⏭️ | ❌ 失败 | 0.2s |
| case-022-white-space | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 8diff 🔴2 | ⏭️ | ❌ 失败 | 0.2s |
| case-023-word-break | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 81diff 🔴10 | ⏭️ | ❌ 失败 | 0.2s |
| case-024-font-weight | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 167diff 🔴98 | ⏭️ | ❌ 失败 | 0.1s |
...
| case-035-text-indent | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 140diff 🔴73 | ⏭️ | ❌ 失败 | 0.2s |
...
| case-046-appearance | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 236diff 🔴186 | ⏭️ | ❌ 失败 | 0.2s |
| case-047-object-fit | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 46diff 🟡30 | ⏭️ | ❌ 失败 | 0.2s |
| case-048-table-props | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 334diff 🔴253 | ⏭️ | ❌ 失败 | 0.2s |
| case-049-multi-column | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 321diff 🔴308 | ⏭️ | ❌ 失败 | 0.2s |
| case-050-text-emphasis | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 275diff 🔴107 | ⏭️ | ❌ 失败 | 0.2s |
...
| case-054-inline-block-nest | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 18diff 🔴10 | ⏭️ | ❌ 失败 | 0.1s |
| case-055-sticky-multi | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 18diff 🔴4 | ⏭️ | ❌ 失败 | 0.1s |

**汇总**: 4 ✅ / 51 ❌ / 55 总计 (总耗时: 53s)
