...
**运行时间**: 2026-07-28 09:27:51 | **总耗时**: 40s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| case-001-wrapper-x | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 32.9s |
...
| case-035-text-indent | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 68diff 🟡8 | ⏭️ | ❌ 失败 | 0.1s |
...
> - case-046-appearance major 13->74
> - case-050-text-emphasis major 161->202
>
...
| 属性 | 通过率 | 通过/总 |
|------|--------|--------|
| width | 98.5% | 8395/8524 |
| height | 98.8% | 8424/8524 |
...
| case-046-appearance | 2 | **33** | **74** | 22 | 0 | 0 |
| case-047-object-fit | 0 | 0 | 0 | 16 | 0 | 0 |
| case-048-table-props | 0 | **19** | **79** | 47 | 0 | 0 |
| case-049-multi-column | 3 | 0 | 0 | 0 | 0 | 0 |
| case-050-text-emphasis | 0 | **50** | **202** | 15 | 0 | 0 |
