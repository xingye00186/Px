...
**运行时间**: 2026-07-27 15:33:05 | **总耗时**: 66.5s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| case-001-wrapper-x | ⏭️ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ❌ 失败 | 41.7s |
...
| case-012-position-relative | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 42diff 🔴1 | ⏭️ | ❌ 失败 | 0.4s |
| case-013-z-index | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 84diff 🔴84 | ⏭️ | ❌ 失败 | 0.3s |
| case-014-overflow-hidden | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 27diff 🔴22 | ⏭️ | ❌ 失败 | 0.4s |
| case-015-min-max-height | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 123diff 🔴51 | ⏭️ | ❌ 失败 | 0.4s |
...
| case-019-visibility | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 235diff 🔴145 | ⏭️ | ❌ 失败 | 0.4s |
| case-020-text-align | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 126diff 🔴3 | ⏭️ | ❌ 失败 | 0.3s |
| case-021-line-height | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 140diff 🔴4 | ⏭️ | ❌ 失败 | 0.4s |
...
| case-035-text-indent | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 141diff 🔴73 | ⏭️ | ❌ 失败 | 0.5s |
...
| case-046-appearance | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 237diff 🔴189 | ⏭️ | ❌ 失败 | 0.4s |
| case-047-object-fit | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 46diff 🟡30 | ⏭️ | ❌ 失败 | 0.4s |
| case-048-table-props | ⏭️ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | 287diff 🔴102 | ⏭️ | ❌ 失败 | 0.5s |
