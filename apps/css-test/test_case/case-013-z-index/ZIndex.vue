<template>
  <div class="bx-card" style="width:720px;margin:20px auto;background:#fff;border-radius:12px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,.08);">
    ...
    <div class="zx-container" style="position:relative;height:160px;margin-bottom:16px;">
      ...
      <div class="zx-mid" style="position:absolute;top:50px;left:100px;width:280px;height:100px;background:linear-gradient(135deg,#0f3460,#4facfe);border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:14px;color:#fff;z-index:2;">z-index:2 (ÖÐ²ã)</div>
