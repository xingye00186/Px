    ...
    <div style="width:620px;background:#f5f5f5;border:1px solid #ccc;">
      <div style="height:44px;background:#1e1e2e;display:flex;align-items:center;padding:0 12px;gap:12px;">
        ...
        <div style="flex:1;max-width:200px;">
          <input style="width:100%;height:28px;background:#313244;border:1px solid #585b70;border-radius:4px;color:#cdd6f4;padding:0 8px;font-size:13px;" placeholder="Search...">
        </div>
...
<script lang="php">
class Prt72IntegComplexSidebarComponent extends \ReactiveComponent
{
    public function render(): \Px\Rendering\VNode
    {
        return \Px\Rendering\VNode::h('#root', ['style'=>'width:800px'],
            \Px\Rendering\VNode::h('div', ['style'=>'width:760px;box-sizing:border-box;background:#fff;border-radius:8px;padding:16px;border:1px solid #e0e0e0;position:relative;'], [
                ...
                \Px\Rendering\VNode::h('div', ['style'=>'font-size:18px;font-weight:600;color:#333;margin-bottom:12px;'], 'Complex Sidebar Layout'),
    ...
    public function __construct(?string $componentId = null) { parent::__construct($componentId ?? 'Prt72IntegComplexSidebar'); }
}
</script>
<style>
