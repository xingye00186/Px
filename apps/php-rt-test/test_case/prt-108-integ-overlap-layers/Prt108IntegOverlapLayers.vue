<template>
  <div class="prt-wrap" style="width:800px;position:relative;">
    ...
    <div style="font-size:12px;color:#999;margin-bottom:8px;"><span style="display:inline-block;width:337px;height:17px;"></span></div>
...
<script lang="php">
class Prt108IntegOverlapLayers extends ReactiveComponent {}
</script>
<style>
