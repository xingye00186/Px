<template>
  <div class="prt-wrap" style="width:800px;position:relative;line-height:0">
    ...
    <div style="width:500px;background:#f5f5f5;border:1px solid #ccc;line-height:0">
      <div style="display:table;width:100%;border-collapse:collapse">
        <div style="display:table-row;background:#e3f2fd">
          ...
          <div style="display:table-cell;border:1px solid #1565c0;padding:8px;width:50%;line-height:0"><span style="display:inline-block;width:62px;height:22px"></span></div>
        </div>
        <div style="display:table-row;background:#fce4ec;line-height:0">
          ...
          <div style="display:table-cell;border:1px solid #c62828;padding:8px;line-height:0"><span style="display:inline-block;width:62px;height:22px"></span></div>
        </div>
      </div>
    </div>
...
<script lang="php">
class Prt69TableBasic extends ReactiveComponent {}
</script>
<style>
