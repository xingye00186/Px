<template>
  <div class="prt-wrap" style="width:800px;position:relative;">
    ...
    <div style="width:400px;height:30px;background:#e3f2fd;border:1px solid #1565c0;text-indent:20px;font-size:14px;"><span><span style="display:inline-block;width:114px;height:22px;"></span></span></div>
