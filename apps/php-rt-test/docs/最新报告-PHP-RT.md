...
**运行时间**: 2026-06-29 17:55:33 | **总耗时**: 212.7s
...
| prt-07-width-height | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 49diff 🔴17 | ⏭️ | ❌ 失败 | 11.3s |
...
| prt-104-margin-percent | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 15diff | ⏭️ | ❌ 失败 | 2.3s |
| prt-105-width-percent-chain | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 5diff | ⏭️ | ❌ 失败 | 7.1s |
| prt-106-min-width-override | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ⚠️ 2 | 20diff 🔴1 | ⏭️ | ❌ 失败 | 1.2s |
| prt-107-max-width-constraint | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ⚠️ 1 | 19diff 🔴1 | ⏭️ | ❌ 失败 | 1.1s |
| prt-108-integ-overlap-layers | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 11diff 🔴1 | ⏭️ | ❌ 失败 | 6.9s |
| prt-109-integ-responsive-card | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 19diff | ⏭️ | ❌ 失败 | 8.1s |
...
| prt-13-position-relative | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 2.3s |
| prt-14-position-absolute | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 2.5s |
| prt-15-position-fixed | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 1diff 🔴1 | ⏭️ | ❌ 失败 | 2.3s |
...
| prt-77-position-sticky | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 34diff | ⏭️ | ❌ 失败 | 4.3s |
| prt-78-clip-path | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ❌ 失败 | 1s |
| prt-79-flex-basis-pct | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 78diff 🔴30 | ⏭️ | ❌ 失败 | 6s |
| prt-80-flex-align-content | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ❌ 1issue | ⚠️ 1 | ✅ | ⏭️ | ❌ 失败 | 9.6s |
| prt-81-flex-column-gap | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 1diff | ⏭️ | ❌ 失败 | 7.1s |
| prt-82-flex-auto-margin | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 2.3s |
...
| prt-95-outline-offset | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 2.3s |
| prt-96-box-shadow-spread | ⏭️ | ✅ | ⏭️ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏭️ | ✅ 通过 | 2.3s |
...
**汇总**: 14 ✅ / 96 ❌ / 110 总计 (总耗时: 212.7s)

## 回归判定

> 🔴 **检测到回归** — 与上一次运行相比，以下指标恶化:
>
> - prop width diff 702->705
> - prt-07-width-height geometry 0->46
> - prt-07-width-height mismatch 0->3
> - prt-07-width-height critical 0->17
> - prt-07-width-height major 0->26
> - prt-108-integ-overlap-layers major 0->2
> - prt-79-flex-basis-pct geometry 6->73
> - prt-79-flex-basis-pct mismatch 3->5
> - prt-79-flex-basis-pct critical 1->30
> - prt-79-flex-basis-pct major 4->37
>
...
| prt-07-width-height | 0 | **17** | **26** | 3 | 0 | 0 |
...
| prt-13-position-relative | 0 | 0 | 0 | 0 | 0 | 0 |
| prt-14-position-absolute | 0 | 0 | 0 | 0 | 0 | 0 |
| prt-15-position-fixed | 0 | **1** | 0 | 0 | 0 | 0 |
...
| prt-79-flex-basis-pct | 0 | **30** | **37** | 5 | 0 | 0 |
| prt-80-flex-align-content | 0 | 0 | 0 | 0 | 0 | 1 |
...
| prt-95-outline-offset | 0 | 0 | 0 | 0 | 0 | 0 |
| prt-96-box-shadow-spread | 0 | 0 | 0 | 0 | 0 | 0 |
