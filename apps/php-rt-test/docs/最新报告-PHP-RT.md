...
**运行时间**: 2026-06-27 23:35:14 | **总耗时**: 135.4s

| 用例 | 构建 | 布局 | 多帧 | 浏览器 | 元素对比 | Phase L | Phase G | 差异 | 截图 | 结果 | 耗时 |
|------|------|------|------|--------|----------|---------|---------|------|------|------|------|
| prt-01-margin | ⏭️ | ✅ | ⏭️ | ✅ | ❌ | ✅ | ✅ | 6diff 🟡2 | ⏭️ | ❌ 失败 | 2.6s |
...
| 属性 | 通过率 | 通过/总 |
|------|--------|--------|
| height | 39.2% | 448/1144 |
| width | 44.1% | 504/1144 |
| font-weight | 76.7% | 877/1144 |
| position | 92.7% | 1060/1144 |
| opacity | 99% | 1132/1144 |
| text-align | 99.4% | 1137/1144 |
| background-color | 67.5% | 623/923 |
| top | 100% | 892/892 |
| left | 100% | 892/892 |
| font-size | 50.8% | 426/839 |
| display | 100% | 769/769 |
| color | 37.1% | 172/463 |
