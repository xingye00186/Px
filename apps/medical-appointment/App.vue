...
<div style="max-width:1200px; margin:0 auto;">
    <div style="background:white; border-radius:32px; padding:28px; box-shadow:0 15px 35px rgba(0,0,0,0.05);position:relative;">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:16px; margin-bottom:28px;">
            <div><h1 style="margin:0; color:#1e3a8a; font-size:28px; font-weight:700;">🏥 在线问诊</h1><p style="margin:4px 0 0; color:#4b5563;">快速预约 · 专家坐诊</p></div>
