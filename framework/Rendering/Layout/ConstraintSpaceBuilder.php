...
class ConstraintSpaceBuilder
{
    ...
    public static function fromLegacyConstraints(
        ...
        return new ConstraintSpace(
            containerWidth:         $lc->containerWidth,
            containerHeight:        $lc->containerHeight,
            parentContentX:         $lc->parentContentX,
            parentContentY:         $lc->parentContentY,
            contentWidth:           $lc->contentWidth,
            contentHeight:          $lc->contentHeight,
            percentageWidth:        $percentageW,
            percentageHeight:       $percentageH,
            paddingTop:             $lc->paddingTop,
            paddingRight:           $lc->paddingRight,
            paddingBottom:          $lc->paddingBottom,
            paddingLeft:            $lc->paddingLeft,
            borderTop:              $lc->borderTop,
            borderRight:            $lc->borderRight,
            borderBottom:           $lc->borderBottom,
            borderLeft:             $lc->borderLeft,
            forceRelayoutChildren:  $lc->forceRelayoutChildren,
            isIntrinsicMeasurement: $lc->isIntrinsicMeasurement,
        );
    }
}
