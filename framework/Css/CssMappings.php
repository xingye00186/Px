...
class CssMappings
{
    ...
    const PROPERTY_MAP = [
        ...
        'flex-grow'        => ['key' => 'flexGrow',    'parser' => 'Px\Css\CssValueParser::parseIdent', 'default' => '0'],
        'flex-basis'       => ['key' => 'flexBasis',    'parser' => 'Px\Css\CssValueParser::parsePixels',  'default' => 'auto'],
        'flex-shrink'      => ['key' => 'flexShrink',   'parser' => 'Px\Css\CssValueParser::parseIdent', 'default' => '1'],
